...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *lineChartViewHeight;
@end
...
//        NSLog(@"%@",dict);
    ...
    {
        _lineChartViewHeight.constant = 300;
    }else if (self.view.frame.size.height > 736)
    {
        _lineChartViewHeight.constant = 400;
    }else if (self.view.frame.size.height > 568)
    {
        _lineChartViewHeight.constant = 350;
    }else
    {
        _lineChartViewHeight.constant = 250;
    }
    
    NSLog(@"%f",_lineChartViewHeight.constant);
//    }];
