...
@property (assign, nonatomic) BOOL                       isSelectTwo;
@property (assign, nonatomic) BOOL                       needsAdjustingMonthPosition;

@property (strong, nonatomic) FSCalendarCell       *FirstSelectCell;
@property (strong, nonatomic) FSCalendarCell       *SecondSelectCell;
...
//    NSArray *weekSymbols = [_calendar shortStandaloneWeekdaySymbols];
    NSArray *weekSymbols = [[NSArray alloc] initWithObjects:@"周日", @"周一", @"周二", @"周三", @"周四", @"周五", @"周六",nil];
...
//        _selectedDate = [self dateForIndexPath:[collectionView indexPathForCell:_FirstSelectCell]];
//    }
    [cell setNeedsLayout];
    return cell;
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView  //Head 前进/后退
{
    if (_supressEvent) {
        return;
    }
...
//- (void)nextMonth:(NSDate *)date animate:(BOOL)animate
//{
//    NSInteger scrollOffset = [date fs_monthsFrom:_minimumDate.fs_firstDayOfMonth];
//    if (self.flow == FSCalendarFlowHorizontal) {
//        [_collectionView setContentOffset:CGPointMake(scrollOffset * _collectionView.fs_width, 0) animated:animate];
...
//}
//
//- (void)lastMonth:(NSDate *)date animate:(BOOL)animate
//{
//    NSInteger scrollOffset = [date fs_monthsFrom:_minimumDate.fs_firstDayOfMonth];
//    if (self.flow == FSCalendarFlowHorizontal) {
//        [_collectionView setContentOffset:CGPointMake(scrollOffset * _collectionView.fs_width, 0) animated:animate];
...
- (void)moveMonth:(NSDate *)date animate:(BOOL)animate
{
    NSInteger scrollOffset = [date fs_monthsFrom:_minimumDate.fs_firstDayOfMonth];
    if (self.flow == FSCalendarFlowHorizontal) {
        [_collectionView setContentOffset:CGPointMake(scrollOffset * _collectionView.fs_width, 0) animated:animate];
